  ...
  exports.employees = employees = [
    {
      ...
      description: "Системное мышление - главное оружение Владимира. Хаос множества технологий структурируется как электроны вокруг атома. Сложнейшие проблемы он разбивает на неделимые частицы, досконально изучает их и встраивает готовый компонент в систему.",
      rank: 2,
      status: "Подмастерье"
    }
  ];
