...
exports.employees = employees = [
  ...
  {
    photo: "/img/employee/roman.png"
    name: "Роман Нестеров"
    occupation: "Team lead"
    brief_description: "Профи указаний"
    description: "Как главный герой сериала, Роман всегда оказывается в нужное время в нужном месте, и пресекает все попытки сайтов работать неправильно. Сложные коды есть на завтрак, обед и ужин. Присмиряет плохое юзабилити, перевоспитывает трудные страницы. Исправляет ошибки с дотошностью учителя русского языка. Помогает клиентам создать сайт интернет магазин с отличными характеристиками."
    rank: 7
  ...
  }
  {
    ...
    description: "Системное мышление - главное оружие Дмитрия. Хаос множества технологий структурируется как электроны вокруг атома. Сложнейшие проблемы он разбивает на неделимые частицы, досконально изучает их и встраивает готовый компонент в систему."
    rank: 2
    status: "Подмастерье"
  }
]
