(function() {
  module.exports = {
    carousel: [
      {
        src: "/img/projects/cappasity/01.png",
        alt: "Сплеш картинка Cappasity.io"
      }, {
        src: "/img/projects/cappasity/03.jpg",
        alt: "Сплеш картинка Cappasity.io"
      }, {
        src: "/img/projects/cappasity/04.jpg",
        alt: "Сплеш картинка Cappasity.io"
      }
    ],
    ...
    activity: ["Архитектура системы", "Дизайн", "Верстка", "Программирование", "Blockchain Development", "UI/UX"],
    ...
    text: ["Browsing experience to online retail through interactive 3D images."]
  };
