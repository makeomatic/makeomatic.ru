...
qq.log = function(a, b) {
    ...
    $.fn.serializeObject = function() {
        ...
        addFileUploader: function() {
            ...
            b.on("error", function() {
                a.addClass("error").text("Ошибка :( пожалуйста позвоните нам");
            }).on("complete", function() {
                a.addClass("success").text("Спасибо за Ваш вопрос, скоро мы с вами свяжемся!"), 
                setTimeout(function() {
                    $("#brief").modal("hide"), $(".brief form").trigger("reset"), b.fineUploader("reset"), 
                    a.removeClass("success").text("Отправить");
                }, 500);
            }), $(".brief form").on("submit", function(c) {
                c.preventDefault();
                var d = $(this);
                return a = $("[type=submit]", d), b.fineUploader("setParams", d.serializeObject()), 
                b.fineUploader("setEndpoint", d.attr("action")), b.fineUploader("uploadStoredFiles"), 
                a.text("Загружаю..."), !1;
            });
        },
