(function(a, b) {
    ...
    b.prototype = {
        ...
        enter: function(b) {
            ...
            return c.options.delay && c.options.delay.show ? (clearTimeout(this.timeout), c.hoverState = "in", 
        ...
        mask: function(b, e) {
            ...
            return !b && this.length > 0 ? (h = a(this[0]), h.data(a.mask.dataName)()) : (e = a.extend({
                ...
                function q(a) {
                    ...
                    0 === d - c && (c = 46 !== e ? n(c) : d = h(c - 1), d = 46 === e ? h(d) : d), s(c, d), 
...
var qq = function(a) {
    return {
        ...
        removeClass: function(b) {
            return a.className = a.className.replace(RegExp("(^| )" + b + "( |$)"), " ").replace(/^\s+|\s+$/g, ""), 
            this;
        },
...
qq.log = function(a, b) {
    ...
    return function(b) {
        return a.innerHTML = b, b = a.firstChild, a.removeChild(b), b;
    };
    ...
    if (qq.isFunction(a)) {
        ...
        return function() {
            return arguments.length && (c = c.concat(Array.prototype.slice.call(arguments))), 
            a.apply(b, c);
        };
    }
    ...
    if (!c && b) f = /\?/.test(b) ? /\?$/.test(b) ? "" : "&" : "?", e.push(b), e.push(qq.obj2url(a)); else if ("[object Array]" === Object.prototype.toString.call(a) && "undefined" != typeof a) for (d = -1, 
    c = a.length; c > d; d += 1) g(a[d], d); else if ("undefined" != typeof a && null !== a && "object" == typeof a) for (d in a) a.hasOwnProperty(d) && g(a[d], d); else e.push(encodeURIComponent(b) + "=" + encodeURIComponent(a));
    ...
    var d = new Date(), e = "";
    c && (d.setTime(d.getTime() + 864e5 * c), e = "; expires=" + d.toGMTString()), document.cookie = a + "=" + b + e + "; path=/";
    ...
    return qq.each(a, function(a, d) {
        ...
        return 0 === e.indexOf(b) ? (c = e.substring(b.length, e.length), !1) : void 0;
    }), c;
    ...
    return qq.setCookie(a, 1), qq.getCookie(a) ? (qq.deleteCookie(a), !0) : !1;
...
}, qq.version = "3.6.3", qq.supportedFeatures = function() {
    var a, b, c, d, e, f;
    a = !0;
    try {
    ...
    return c = (b = a && qq.isXhrUploadSupported()) && qq.chrome() && void 0 !== navigator.userAgent.match(/Chrome\/[2][1-9]|Chrome\/[3-9][0-9]/), 
    d = b && qq.isFileChunkingSupported(), e = b && d && qq.areCookiesEnabled(), f = b && qq.chrome() && void 0 !== navigator.userAgent.match(/Chrome\/[1][4-9]|Chrome\/[2-9][0-9]/), 
    {
        uploading: a,
        ajaxUploading: b,
        fileDrop: b,
    ...
    return {
        then: function(e, g) {
            return 0 === f ? (e && c.push(e), g && d.push(g)) : -1 === f && g ? g(b) : e && e(a), 
            this;
        },
        done: function(a) {
    ...
    function b() {
        var a = document.createElement("input");
        return e.multiple && a.setAttribute("multiple", "multiple"), e.acceptFiles && a.setAttribute("accept", e.acceptFiles), 
        a.setAttribute("type", "file"), a.setAttribute("name", e.name), qq(a).css({
            position: "absolute",
            right: 0,
            top: 0,
            fontFamily: "Arial",
    ...
    function d(a) {
        var b = [];
        return a = [].concat(a), qq.each(a, function(a, c) {
            var d = h[c];
    ...
    return {
        added: function(b) {
            var c = a.getUuid(b), d = a.getName(b), i = a.getSize(b), j = qq.status.SUBMITTING, d = e.push({
                id: b,
                name: d,
                uuid: c,
                size: i,
            ...
            f[b] = d, g[c] = d, void 0 === h[j] && (h[j] = []), h[j].push(d), a.onStatusChange(b, void 0, j);
        },
        retrieve: function(a) {
        ...
        setStatus: function(b, c) {
            ...
            h[g].splice(i, 1), e[d].status = c, void 0 === h[c] && (h[c] = []), h[c].push(d), 
            a.onStatusChange(b, g, c);
        },
    ...
    this._options = {
        ...
        formatFileName: function(a) {
            return 33 < a.length && (a = a.slice(0, 19) + "..." + a.slice(-14)), a;
        },
        text: {
    ...
    }, qq.extend(this._options, a, !0), this._handleCameraAccess(), this._wrapCallbacks(), 
    this._disposeSupport = new qq.DisposeSupport(), this._filesInProgress = [], this._storedIds = [], 
    this._autoRetries = [], this._retryTimeouts = [], this._preventRetries = [], this._netUploaded = this._netUploadedOrQueued = 0, 
    this._uploadData = this._createUploadDataTracker(), this._paramsStore = this._createParamsStore("request"), 
    this._deleteFileParamsStore = this._createParamsStore("deleteFile"), this._endpointStore = this._createEndpointStore("request"), 
    this._deleteFileEndpointStore = this._createEndpointStore("deleteFile"), this._handler = this._createUploadHandler(), 
    this._deleteHandler = this._createDeleteHandler(), this._options.button && (this._button = this._createUploadButton(this._options.button)), 
    ...
    reset: function() {
        ...
        this._button.reset(), this._paramsStore.reset(), this._endpointStore.reset(), this._netUploaded = this._netUploadedOrQueued = 0, 
        this._uploadData.reset(), this._pasteHandler && this._pasteHandler.reset();
    },
    addFiles: function(a, b, c) {
        var d, e, f, g = [];
        if (a) {
            for (qq.isFileList(a) || (a = [].concat(a)), d = 0; d < a.length; d += 1) if (e = a[d], 
            qq.isFileOrInput(e)) if (qq.isInput(e) && qq.supportedFeatures.ajaxUploading) for (f = 0; f < e.files.length; f++) g.push(e.files[f]); else g.push(e); else this.log(e + " is not a File or INPUT element!  Ignoring!", "warn");
    ...
    _handleCheckedCallback: function(a) {
        ...
        return qq.isPromise(c) ? (this.log(a.name + " - waiting for " + a.name + " promise to be fulfilled for " + a.identifier), 
        c.then(function(c) {
    ...
    _handlePasteSuccess: function(a, b) {
        ...
        null == d && (d = this._options.paste.defaultName), this.addBlobs({
            name: d + ("." + c),
            blob: a
        });
    },
    _preventLeaveInProgress: function() {
        ...
        this._disposeSupport.attach(window, "beforeunload", function(b) {
            return a._filesInProgress.length ? (b = b || window.event, b.returnValue = a._options.messages.onLeave) : void 0;
        });
    },
    ...
    _onComplete: function(a, b, c, d) {
        ...
        this._netUploadedOrQueued--), this._removeFromFilesInProgress(a), this._maybeParseAndSendUploadError(a, b, c, d);
    },
    _onCancel: function(a) {
        this._uploadData.setStatus(a, qq.status.CANCELED), this._netUploadedOrQueued--, 
    ...
    _removeFromFilesInProgress: function(a) {
        a = qq.indexOf(this._filesInProgress, a), a >= 0 && this._filesInProgress.splice(a, 1);
    },
    ...
    _onAutoRetry: function(a, b) {
        this.log("Retrying " + b + "..."), this._autoRetries[a]++, this._uploadData.setStatus(a, qq.status.UPLOAD_RETRYING), 
    ...
    _onBeforeManualRetry: function(a) {
        ...
        if (this._handler.isValid(a)) {
            ...
            return !1 === this._options.callbacks.onManualRetry(a, c) ? !1 : b > 0 && this._netUploadedOrQueued + 1 > b ? (this._itemError("retryFailTooManyItems", ""), 
    ...
    _maybeParseAndSendUploadError: function(a, b, c, d) {
        c.success || (d && 200 !== d.status && !c.error ? this._options.callbacks.onError(a, b, "XHR returned response code " + d.status, d) : this._options.callbacks.onError(a, b, c.error ? c.error : this._options.text.defaultResponseError, d));
    },
    ...
    _upload: function(a, b, c) {
        ...
        var d = this._handler.getName(a);
        this._uploadData.added(a), b && this.setParams(b, a), c && this.setEndpoint(c, a), 
        this._handleCheckedCallback({
            name: "onSubmit",
    ...
    _onSubmitCallbackSuccess: function(a, b) {
        this._uploadData.setStatus(a, qq.status.SUBMITTED), this._onSubmit(a, b), this._options.callbacks.onSubmitted(a, b), 
    ...
    _onValidateBatchCallbackSuccess: function(a, b, c, d) {
        ...
        a = this._netUploadedOrQueued + a.length, 0 === e || e >= a ? 0 < b.length ? this._handleCheckedCallback({
            name: "onValidate",
    ...
    _validateFileOrBlobData: function(a, b) {
        ...
        return !1 === this._options.callbacks.onValidate(b) && (e = !1), qq.isFileOrInput(a) && !this._isAllowedExtension(c) ? (this._itemError("typeError", c), 
        ...
        e = !1), e || this._fileOrBlobRejected(void 0, c), e;
    },
    ...
    _itemError: function(a, b) {
        ...
        var d, e = this._options.messages[a], f = [], g = [].concat(b), h = g[0];
        return qq.each(this._options.validation.allowedExtensions, function(a, b) {
            qq.isString(b) && f.push(b);
        }), d = f.join(", ").toLowerCase(), c("{file}", this._options.formatFileName(h)), 
        c("{extensions}", d), c("{sizeLimit}", this._formatSize(this._options.validation.sizeLimit)), 
        c("{minSizeLimit}", this._formatSize(this._options.validation.minSizeLimit)), d = e.match(/(\{\w+\})/g), 
        null !== d && qq.each(d, function(a, b) {
            c(b, g[a]);
        }), this._options.callbacks.onError(null, h, e, void 0), e;
    },
    ...
    _isAllowedExtension: function(a) {
        ...
        return b.length ? (qq.each(b, function(b, d) {
            return qq.isString(d) && null != a.match(RegExp("\\." + d + "$", "i")) ? (c = !0, 
            !1) : void 0;
        }), c) : !0;
    },
    ...
    _parseFileOrBlobDataSize: function(a) {
        var b;
        return qq.isFileOrInput(a) ? a.value || (b = null !== a.fileSize && void 0 !== a.fileSize ? a.fileSize : a.size) : b = a.blob.size, 
        b;
    },
    _getValidationDescriptor: function(a) {
        var b, c;
        return c = {}, b = this._parseFileOrBlobDataName(a), a = this._parseFileOrBlobDataSize(a), 
        c.name = b, void 0 !== a && (c.size = a), c;
    },
    ...
    function c(a) {
        ...
        if (f.callbacks.processingDroppedFiles(), g.dropDisabled(!0), 1 < a.files.length && !f.allowMultipleItems) f.callbacks.processingDroppedFilesComplete([]), 
        f.callbacks.dropError("tooManyFilesError", ""), g.dropDisabled(!1), i.failure(); else {
            if (h = [], qq.isFolderDropSupported(a)) for (c = a.items, a = 0; a < c.length; a += 1) (d = c[a].webkitGetAsEntry()) && (d.isFile ? h.push(c[a].getAsFile()) : e.push(b(d).done(function() {
                e.pop(), 0 === e.length && i.success();
            }))); else h = a.files;
    ...
    function d(a) {
        g = new qq.UploadDropZone({
            element: a,
            onEnter: function(b) {
                qq(a).addClass(f.classes.dropActive), b.stopPropagation();
            },
            onLeaveNotDescendants: function() {
                qq(a).removeClass(f.classes.dropActive);
            },
            onDrop: function(b) {
                f.hideDropZonesBeforeEnter && qq(a).hide(), qq(a).removeClass(f.classes.dropActive), 
                c(b.dataTransfer).done(function() {
                    var a = h;
                    f.callbacks.dropLog("Grabbed " + a.length + " dropped files."), g.dropDisabled(!1), 
    ...
    function c(a) {
        ...
        var b = a.dataTransfer, c = qq.safari();
        return a = qq.ie10() ? !0 : "none" !== b.effectAllowed, b && a && (b.files || !c && b.types.contains && b.types.contains("Files"));
    }
    function d(a) {
        return void 0 !== a && (g = a), g;
    }
    ...
    return e = {
        ...
        onLeaveNotDescendants: function() {},
        onDrop: function() {}
    }, qq.extend(e, a), f = e.element, function() {
        ...
        i.attach(f, "dragover", function(a) {
            ...
            if (c(a)) {
                ...
                qq(this).contains(b) || e.onLeaveNotDescendants(a);
            }
    ...
    qq.FineUploaderBasic.apply(this, arguments), qq.extend(this._options, {
        ...
        showPrompt: function(a, b) {
            ...
            return null != d && 0 < qq.trimStr(d).length ? c.success(d) : c.failure("Undefined or invalid user-supplied value."), 
            c;
        }
    }, !0), qq.extend(this._options, a, !0), !qq.supportedFeatures.uploading || this._options.cors.expected && !qq.supportedFeatures.uploadCors ? this._options.element.innerHTML = "<div>" + this._options.messages.unsupportedBrowser + "</div>" : (this._wrapCallbacks(), 
    ...
    _removeFileItem: function(a) {
        a = this.getItemByFileId(a), qq(a).remove();
    },
    _setupDragAndDrop: function() {
        var a, b = this, c = this._find(this._element, "dropProcessing"), d = this._options.dragAndDrop.extraDropzones;
        return a = function(a) {
            a.preventDefault();
        }, this._options.dragAndDrop.disableDefaultDropzone || d.push(this._find(this._options.element, "drop")), 
        new qq.DragAndDrop({
            dropZoneElements: d,
    ...
    _onProgress: function(a, b, c, d) {
        ...
        var e, f, g, h;
        e = this.getItemByFileId(a), f = this._find(e, "progressBar"), g = Math.round(100 * (c / d)), 
    ...
    _onComplete: function(a, b, c) {
        ...
        qq(this._find(d, "statusText")).clearText(), qq(d).removeClass(this._classes.retrying), 
        qq(this._find(d, "progressBar")).hide(), (!this._options.disableCancelForFormUploads || qq.supportedFeatures.ajaxUploading) && qq(this._find(d, "cancel")).hide(), 
        qq(this._find(d, "spinner")).hide(), c.success ? (this._isDeletePossible() && this._showDeleteLink(a), 
        qq(d).addClass(this._classes.success), this._classes.successIcon && (this._find(d, "finished").style.display = "inline-block", 
        qq(d).addClass(this._classes.successIcon))) : (qq(d).addClass(this._classes.fail), 
        this._classes.failIcon && (this._find(d, "finished").style.display = "inline-block", 
        qq(d).addClass(this._classes.failIcon)), this._options.retry.showButton && !this._preventRetries[a] && qq(d).addClass(this._classes.retryable), 
        this._controlFailureTextDisplay(d, c));
    },
    _onUpload: function(a) {
    ...
    _onBeforeManualRetry: function(a) {
        ...
        this._showSpinner(a), this._showCancelLink(b), !0) : (qq(b).addClass(this._classes.retryable), 
        !1);
    },
    ...
    _onDeleteComplete: function(a, b, c) {
        ...
        qq(e).hide(), c ? (qq(d).setText(this._options.deleteFile.deletingFailedText), this._showDeleteLink(a)) : this._removeFileItem(a);
    },
    _sendDeleteRequest: function(a) {
        var b = this.getItemByFileId(a), c = this._find(b, "deleteButton"), b = this._find(b, "statusText");
        qq(c).hide(), this._showSpinner(a), qq(b).setText(this._options.deleteFile.deletingStatusText), 
        this._deleteHandler.sendDelete(a, this.getUuid(a));
    },
    _showDeleteConfirm: function(a) {
        var b = this._handler.getName(a), b = this._options.deleteFile.confirmMessage.replace(/\{filename\}/g, b);
        this.getUuid(a);
        var c = this;
    ...
    _addToList: function(a, b) {
        ...
        c.qqFileId = a, d = this._find(c, "file"), qq(d).setText(this._options.formatFileName(b)), 
        qq(this._find(c, "size")).hide(), this._options.multiple || (this._handler.cancelAll(), 
        this._clearList()), this._options.display.prependFiles ? this._prependItem(c) : this._listElement.appendChild(c), 
        this._filesInBatchAddedToUi += 1, this._options.display.fileSizeOnSubmit && qq.supportedFeatures.ajaxUploading && this._displayFileSize(a);
    },
    ...
    _displayFileSize: function(a, b, c) {
        var d = this.getItemByFileId(a);
        a = this.getSize(a), a = this._formatSize(a), d = this._find(d, "size"), void 0 !== b && void 0 !== c && (a = this._formatProgress(b, c)), 
        qq(d).css({
            display: "inline"
        }), qq(d).setText(a);
    },
    _bindCancelAndRetryEvents: function() {
        ...
        this._disposeSupport.attach(this._listElement, "click", function(b) {
            ...
            if (qq(c).hasClass(a._classes.cancel) || qq(c).hasClass(a._classes.retry) || qq(c).hasClass(a._classes.deleteButton)) {
                for (qq.preventDefault(b), b = c.parentNode; void 0 === b.qqFileId; ) b = b.parentNode;
    ...
    _controlFailureTextDisplay: function(a, b) {
        ...
        e = this._options.failedUploadTextDisplay.responseProperty, "custom" === c ? ((c = b[e]) ? c.length > d && (f = c.substring(0, d) + "...") : (c = this._options.text.failUpload, 
    ...
    _showSpinner: function(a) {
        a = this.getItemByFileId(a), this._find(a, "spinner").style.display = "inline-block";
    },
    _showCancelLink: function(a) {
        (!this._options.disableCancelForFormUploads || qq.supportedFeatures.ajaxUploading) && (a = this._find(a, "cancel"), 
        qq(a).css({
            display: "inline"
        }));
    },
    _showDeleteLink: function(a) {
        a = this.getItemByFileId(a), a = this._find(a, "deleteButton"), qq(a).css({
            display: "inline"
        });
    },
    _itemError: function() {
    ...
    function b(a) {
        ...
        delete j[a], i.splice(b, 1), i.length >= d && d > b && (a = i[d - 1], c(a));
    }
    function c(a) {
        var b, c = new XMLHttpRequest(), i = f(), l = {};
        k.onSend(a), k.paramsStore.getParams && (l = k.paramsStore.getParams(a)), b = l;
        var m = k.endpointStore.getEndpoint(a), n = j[a].addToPath;
        void 0 !== n && (m += "/" + n), b = h && b ? qq.obj2url(b, m) : m, j[a].xhr = c, 
        c.onreadystatechange = d(a), c.open(i, b, !0), k.cors.expected && k.cors.sendCredentials && (c.withCredentials = !0), 
        e(a), g("Sending " + i + " request for " + a), !h && l ? c.send(qq.obj2url(l, "")) : c.send();
    }
    function d(a) {
        var c = j[a].xhr;
        return function() {
            if (4 === c.readyState) {
                ...
                b(a), 0 <= qq.indexOf(k.successfulResponseCodes, d.status) || (h = !0, g(e + " request for " + a + " has failed - response code " + d.status, "error")), 
                k.onComplete(a, d, h);
            }
        };
    }
    function e(a) {
        var b = j[a].xhr;
        a = k.customHeaders, b.setRequestHeader("X-Requested-With", "XMLHttpRequest"), b.setRequestHeader("Cache-Control", "no-cache"), 
    ...
    return qq.extend(k, a), g = k.log, h = "GET" === f() || "DELETE" === f(), {
        send: function(a, b) {
            j[a] = {
                addToPath: b
        ...
        cancel: function(a) {
            var c = j[a].xhr, d = f();
            return c ? (c.onreadystatechange = null, c.abort(), b(a), g("Cancelled " + d + " for " + a), 
            k.onCancel(a), a = !0) : a = !1, a;
        }
    };
    ...
    return qq.extend(c, a), b = new qq.AjaxRequestor({
        method: "DELETE",
        ...
        sendDelete: function(a, d) {
            b.send(a, d), c.log("Submitted delete file request for " + a);
        }
    };
    ...
    function b(a) {
        a = qq.indexOf(h, a);
        var b = d.maxConnections;
        a >= 0 && (h.splice(a, 1), h.length >= b && b > a && (a = h[b - 1], f.upload(a)));
    }
    function c(a) {
    ...
    }, qq.extend(d, a), e = d.log, f = qq.supportedFeatures.ajaxUploading ? new qq.UploadHandlerXhr(d, b, d.onUuidChanged, e) : new qq.UploadHandlerForm(d, b, d.onUuidChanged, e), 
    g = {
        add: function(a) {
            return f.add(a);
        },
        upload: function(a) {
            return h.push(a) <= d.maxConnections ? (f.upload(a), !0) : !1;
        },
        retry: function(a) {
            return 0 <= qq.indexOf(h, a) ? f.upload(a, !0) : this.upload(a);
        },
        cancel: function(a) {
            var b = f.cancel(a);
    ...
    function f(a, b) {
        ...
        t[o[d]] = b, p[d] = qq(a).attach("load", function() {
            n[d] && (r("Received iframe load event for CORS upload request (iframe name " + c + ")"), 
        ...
        }), s.receiveMessage(c, function(a) {
            r("Received the following window message: '" + a + "'");
            var b = h(c.split("_")[0], a), d = b.uuid;
            d && t[d] ? (r("Handling response for iframe name " + c), clearTimeout(q[c]), delete q[c], 
            e(c), a = t[d], delete t[d], s.stopReceivingMessages(c), a(b)) : d || r("'" + a + "' does not contain a UUID - ignoring.");
        });
    }
    function g(a, b) {
        m.cors.expected ? f(a, b) : p[a.id] = qq(a).attach("load", function() {
            if (r("Received response for " + a.id), a.parentNode) {
                try {
                    if (a.contentDocument && a.contentDocument.body && "false" == a.contentDocument.body.innerHTML) return;
                } catch (c) {
                    r("Error when attempting to access iframe during handling of upload response (" + c + ")", "error");
                }
                b();
            }
        });
    ...
    function h(a, b) {
        var c;
        try {
            c = qq.parseJson(b), void 0 !== c.newUuid && (r("Server requested UUID change from '" + o[a] + "' to '" + c.newUuid + "'"), 
            o[a] = c.newUuid, onUuidChanged(a, c.newUuid));
        } catch (d) {
            r("Error when attempting to parse iframe upload response (" + d + ")", "error"), 
            c = {};
        }
        return c;
    }
    ...
    function j(a, b) {
        var c = m.paramsStore.getParams(a), d = qq.toElement('<form method="' + (m.demoMode ? "GET" : "POST") + '" enctype="multipart/form-data"></form>'), e = m.endpointStore.getEndpoint(a), f = e;
        return c[m.uuidParamName] = o[a], m.paramsInBody ? qq.obj2Inputs(c, d) : f = qq.obj2url(c, e), 
        d.setAttribute("action", f), d.setAttribute("target", b.name), d.style.display = "none", 
        document.body.appendChild(d), d;
    }
    function k(a) {
        delete n[a], delete o[a], delete p[a], m.cors.expected && (clearTimeout(q[a]), delete q[a], 
        s.stopReceivingMessages(a)), (a = document.getElementById(a + "_" + u)) && (a.setAttribute("src", "java" + String.fromCharCode(115) + "cript:false;"), 
        qq(a).remove());
    }
    var l, m = a, n = [], o = [], p = {}, q = {}, r = d, s = new qq.WindowReceiveMessage({
        log: r
    }), t = {}, u = qq.getUniqueId();
    return l = {
        add: function(a) {
            a.setAttribute("name", m.inputName);
            var b = n.push(a) - 1;
            return o[b] = qq.getUniqueId(), a.parentNode && qq(a).remove(), b;
        },
        getName: function(a) {
            return l.isValid(a) ? n[a].value.replace(/.*(\/|\\)/, "") : (r(a + " is not a valid item ID.", "error"), 
            void 0);
        },
        isValid: function(a) {
            return void 0 !== n[a];
        ...
        cancel: function(a) {
            var b = m.onCancel(a, l.getName(a));
            return qq.isPromise(b) ? b.then(function() {
                k(a);
            }) : !1 !== b ? (k(a), !0) : !1;
        },
        upload: function(a) {
            var c, d = n[a], f = l.getName(a), k = i(a);
            if (!d) throw Error("file with passed id was not added, or already uploaded or cancelled");
            m.onUpload(a, l.getName(a)), c = j(a, k), c.appendChild(d), g(k, function(c) {
                if (r("iframe loaded"), !c) {
                    var d;
                    try {
                        var g = k.contentDocument || k.contentWindow.document, i = g.body.innerHTML;
                        r("converting iframe's innerHTML to JSON"), r("innerHTML = " + i), i && i.match(/^<pre/i) && (i = g.body.firstChild.firstChild.nodeValue), 
                        d = h(a, i);
                    } catch (j) {
                        r("Error when attempting to parse form upload response (" + j + ")", "error"), d = {
                            success: !1
                        };
                    }
                    c = d;
                }
                e(a), m.cors.expected || qq(k).remove(), (c.success || !m.onAutoRetry(a, f, c)) && (m.onComplete(a, f, c), 
                b(a));
            }), r("Sending upload request for " + a), c.submit(), qq(c).remove();
        }
    };
}, qq.UploadHandlerXhr = function(a, b, c, d) {
    function e(a, b, c) {
        var d = G.getSize(a);
        a = G.getName(a), b[z.chunking.paramNames.partIndex] = c.part, b[z.chunking.paramNames.partByteOffset] = c.start, 
        b[z.chunking.paramNames.chunkSize] = c.size, b[z.chunking.paramNames.totalParts] = c.count, 
        b[z.totalFileSizeParamName] = d, H && (b[z.chunking.paramNames.filename] = a);
    }
    function f(a, b) {
        var c = z.chunking.partSize, d = G.getSize(a), e = C[a].file || C[a].blobData.blob, f = c * b, c = f + c >= d ? d : f + c, d = g(a);
        return e = e.slice ? e.slice(f, c) : e.mozSlice ? e.mozSlice(f, c) : e.webkitSlice ? e.webkitSlice(f, c) : void 0, 
        {
            part: b,
            start: f,
            end: c,
    ...
    function g(a) {
        return a = G.getSize(a), Math.ceil(a / z.chunking.partSize);
    }
    function h(a) {
    ...
    function i(a, b, c, d) {
        var e = new FormData(), f = z.demoMode ? "GET" : "POST", g = z.endpointStore.getEndpoint(d), h = g, i = G.getName(d), j = G.getSize(d), k = C[d].blobData;
        return a[z.uuidParamName] = C[d].uuid, H && (a[z.totalFileSizeParamName] = j, k && (a[z.blobs.paramNames.name] = k.name)), 
        z.paramsInBody || (H || (a[z.inputName] = i), h = qq.obj2url(a, g)), b.open(f, h, !0), 
        z.cors.expected && z.cors.sendCredentials && (b.withCredentials = !0), H ? (z.paramsInBody && qq.obj2FormData(a, e), 
        e.append(z.inputName, c), e) : c;
    }
    function j(a, b) {
        var c = z.customHeaders, d = C[a].file || C[a].blobData.blob;
        b.setRequestHeader("X-Requested-With", "XMLHttpRequest"), b.setRequestHeader("Cache-Control", "no-cache"), 
        H || (b.setRequestHeader("Content-Type", "application/octet-stream"), b.setRequestHeader("X-Mime-Type", d.type)), 
        qq.each(c, function(a, c) {
            b.setRequestHeader(a, c);
        });
    }
    function k(a, b, c) {
        var d = G.getName(a), e = G.getSize(a);
        C[a].attemptingResume = !1, z.onProgress(a, d, e, e), z.onComplete(a, d, b, c), 
        C[a] && delete C[a].xhr, A(a);
    }
    function l(a) {
        var b, c = C[a].remainingChunkIdxs[0], d = f(a, c), g = h(a), k = G.getSize(a), l = G.getName(a);
        void 0 === C[a].loaded && (C[a].loaded = 0), F && C[a].file && p(a, d), g.onreadystatechange = o(a, g), 
        g.upload.onprogress = function(b) {
            if (b.lengthComputable) {
                var d = b.loaded + C[a].loaded;
                b = b.total;
                var e = f(a, c);
                b -= e.size;
                var g = G.getSize(a), e = e.count, h = b - C[a].initialRequestOverhead;
                C[a].lastRequestOverhead = b, 0 === c ? (C[a].lastChunkIdxProgress = 0, C[a].initialRequestOverhead = b, 
                C[a].estTotalRequestsSize = g + e * b) : C[a].lastChunkIdxProgress !== c && (C[a].lastChunkIdxProgress = c, 
                C[a].estTotalRequestsSize += h), z.onProgress(a, l, d, C[a].estTotalRequestsSize);
            }
        }, z.onUploadChunk(a, l, n(d)), b = z.paramsStore.getParams(a), e(a, b, d), C[a].attemptingResume && (b[z.resume.paramNames.resuming] = !0), 
        b = i(b, g, d.blob, a), j(a, g), B("Sending chunked upload request for item " + a + ": bytes " + (d.start + 1) + "-" + d.end + " of " + k), 
        g.send(b);
    }
    function m(a) {
        B("Server has ordered chunking effort to be restarted on next attempt for item ID " + a, "error"), 
        F && (q(a), C[a].attemptingResume = !1), C[a].remainingChunkIdxs = [], delete C[a].loaded, 
        delete C[a].estTotalRequestsSize, delete C[a].initialRequestOverhead;
    }
    function n(a) {
        return {
            partIndex: a.part,
    ...
    function o(a, b) {
        return function() {
            if (4 === b.readyState) {
                var c;
                if (C[a]) {
                    B("xhr - server response received for " + a), B("responseText = " + b.responseText);
                    try {
                        c = qq.parseJson(b.responseText), void 0 !== c.newUuid && (B("Server requested UUID change from '" + C[a].uuid + "' to '" + c.newUuid + "'"), 
                        C[a].uuid = c.newUuid, onUuidChanged(a, c.newUuid));
                    } catch (d) {
                        B("Error when attempting to parse xhr response text (" + d + ")", "error"), c = {};
                    }
                    if (200 !== b.status || !c.success || c.reset) if (c.reset && m(a), C[a].attemptingResume && c.reset) C[a].attemptingResume = !1, 
                    B("Server has declared that it cannot handle resume for item ID " + a + " - starting from the first chunk", "error"), 
                    m(a), G.upload(a, !0); else {
                        var e = G.getName(a);
                        z.onAutoRetry(a, e, c, b) || k(a, c, b);
                    } else if (E) {
                        var e = C[a].remainingChunkIdxs.shift(), g = f(a, e);
                        C[a].attemptingResume = !1;
                        var h, e = C[a], i = e.loaded, g = g.size;
                        h = H ? C[a].lastRequestOverhead : 0, e.loaded = i + (g + h), 0 < C[a].remainingChunkIdxs.length ? l(a) : (F && q(a), 
                        k(a, c, b));
                    } else k(a, c, b);
                }
            }
    ...
    function p(a, b) {
        var c = G.getUuid(a), d = C[a].loaded, e = C[a].initialRequestOverhead, f = C[a].estTotalRequestsSize, g = s(a);
        qq.setCookie(g, c + D + b.part + D + d + D + e + D + f, z.resume.cookiesExpireIn);
    }
    function q(a) {
        C[a].file && (a = s(a), qq.deleteCookie(a));
    }
    function r(a) {
        var b = qq.getCookie(s(a));
        a = G.getName(a);
        var c, d, e;
        if (b) {
            if (b = b.split(D), 5 === b.length) return a = b[0], c = parseInt(b[1], 10), d = parseInt(b[2], 10), 
            ...
            B("Ignoring previously stored resume/chunk cookie for " + a + " - old cookie format", "warn");
        }
    }
    function s(a) {
        var b = G.getName(a);
        a = G.getSize(a);
        var c = z.chunking.partSize, b = "qqfilechunk" + D + encodeURIComponent(b) + D + a + D + c;
        return void 0 !== y && (b += D + y), b;
    }
    function t(a, b) {
        var c;
        for (c = g(a) - 1; c >= b; c -= 1) C[a].remainingChunkIdxs.unshift(c);
        l(a);
    }
    function u(a, b, c, d) {
        c = d.part, C[a].loaded = d.lastByteSent, C[a].estTotalRequestsSize = d.estTotalRequestsSize, 
        C[a].initialRequestOverhead = d.initialRequestOverhead, C[a].attemptingResume = !0, 
        B("Resuming " + b + " at partition index " + c), t(a, c);
    }
    function v(a, b, c) {
        var d = G.getName(a), e = f(a, b.part), e = z.onResume(a, d, n(e));
        qq.isPromise(e) ? (B("Waiting for onResume promise to be fulfilled for " + a), e.then(function() {
            u(a, d, c, b);
        }, function() {
            B("onResume promise fulfilled - failure indicated.  Will not resume."), t(a, c);
        })) : !1 !== e ? u(a, d, c, b) : (B("onResume callback returned false.  Will not resume."), 
        t(a, c));
    }
    function w(a) {
        var b, c, d = C[a].file || C[a].blobData.blob, e = G.getName(a);
        C[a].loaded = 0, b = h(a), b.upload.onprogress = function(b) {
            b.lengthComputable && (C[a].loaded = b.loaded, z.onProgress(a, e, b.loaded, b.total));
        }, b.onreadystatechange = o(a, b), c = z.paramsStore.getParams(a), d = i(c, b, d, a), 
        j(a, b), B("Sending upload request for " + a), b.send(d);
    }
    function x(a) {
        var b = C[a].xhr;
        b && (b.onreadystatechange = null, b.abort()), F && q(a), delete C[a];
    }
    var y, z = a, A = b, B = d, C = [], D = "|", E = z.chunking.enabled && qq.supportedFeatures.chunking, F = z.resume.enabled && E && qq.supportedFeatures.resume;
    y = null === z.resume.id || void 0 === z.resume.id || qq.isFunction(z.resume.id) || qq.isObject(z.resume.id) ? void 0 : z.resume.id;
    var G, H = z.forceMultipart || z.paramsInBody;
    return G = {
        add: function(a) {
            var b, c = qq.getUniqueId();
            if (qq.isFile(a)) a = C.push({
                file: a
            }) - 1; else {
                if (!qq.isBlob(a.blob)) throw Error("Passed obj in not a File or BlobData (in qq.UploadHandlerXhr)");
                a = C.push({
                    blobData: a
                }) - 1;
            }
            return F && (b = r(a)) && (c = b.uuid), C[a].uuid = c, a;
        },
        getName: function(a) {
            if (G.isValid(a)) {
                var b = C[a].file;
                return a = C[a].blobData, b ? null !== b.fileName && void 0 !== b.fileName ? b.fileName : b.name : a.name;
            }
            B(a + " is not a valid item ID.", "error");
        },
        getSize: function(a) {
            return a = C[a].file || C[a].blobData.blob, qq.isFileOrInput(a) ? null != a.fileSize ? a.fileSize : a.size : a.size;
        },
        getFile: function(a) {
            return C[a] ? C[a].file || C[a].blobData.blob : void 0;
        },
        isValid: function(a) {
            return void 0 !== C[a];
        },
        ...
        upload: function(a, b) {
            ...
            this.isValid(a) && (z.onUpload(a, c), E ? C[a].remainingChunkIdxs && 0 !== C[a].remainingChunkIdxs.length ? l(a) : (C[a].remainingChunkIdxs = [], 
            F && !b && C[a].file ? (c = r(a)) ? v(a, c, 0) : t(a, 0) : t(a, 0)) : w(a));
        },
        cancel: function(a) {
            var b = z.onCancel(a, this.getName(a));
            return qq.isPromise(b) ? b.then(function() {
                x(a);
            }) : !1 !== b ? (x(a), !0) : !1;
        },
        getResumableFilesData: function() {
            var a = [], b = [];
            return E && F ? (a = void 0 === y ? qq.getCookieNames(RegExp("^qqfilechunk\\" + D + ".+\\" + D + "\\d+\\" + D + z.chunking.partSize + "=")) : qq.getCookieNames(RegExp("^qqfilechunk\\" + D + ".+\\" + D + "\\d+\\" + D + z.chunking.partSize + "\\" + D + y + "=")), 
            qq.each(a, function(a, c) {
                var d = c.split(D), e = qq.getCookie(c).split(D);
                b.push({
    ...
    g = [ "uploaderType" ], d = function(a) {
        return a && (a = i(a), h(a), "basic" === f("uploaderType") ? b(new qq.FineUploaderBasic(a)) : b(new qq.FineUploader(a))), 
        c;
    }, e = function(a, b) {
        ...
        var d = b.callbacks = {};
        b = new qq.FineUploaderBasic(), a.each(b._options.callbacks, function(a) {
            var b, e;
            b = /^on(\w+)/.exec(a)[1], b = b.substring(0, 1).toLowerCase() + b.substring(1), 
            e = c, d[a] = function() {
        ...
        return e = void 0 === d ? "basic" !== b.uploaderType ? {
            ...
            0 <= a.inArray(b, g) ? f(b, c) : c instanceof a ? e[b] = c[0] : a.isPlainObject(c) ? (e[b] = {}, 
        ...
        }), 1 === h.length ? h[0] : 1 < h.length ? h : this;
    };
}(jQuery), function(a) {
    function b(a) {
        return a || (a = {}), a.dropZoneElements = [ g ], a = e(a), d(a), c(new qq.DragAndDrop(a)), 
        g;
    }
    function c(a) {
        var b = g.data(h);
        return a ? (void 0 === b && (b = {}), b.dndInstance = a, g.data(h, b), a = void 0) : a = void 0 === b ? null : b.dndInstance, 
        a;
    }
    function d(b) {
        var c = b.callbacks = {};
    ...
    function e(b, c) {
        ...
        return d = void 0 === c ? {} : c, a.each(b, function(b, c) {
            c instanceof a ? d[b] = c[0] : a.isPlainObject(c) ? (d[b] = {}, e(c, d[b])) : a.isArray(c) ? (f = [], 
    ...
    function f(a) {
        ...
        return e(d, b), c()[a].apply(c(), b);
    }
    var g, h = "fineUploaderDnd";
    a.fn.fineUploaderDnd = function(d) {
        var e = this, h = arguments, i = [];
        return this.each(function(j, k) {
            if (g = a(k), c() && "string" === a.type(d) && "dispose" === d && void 0 !== c()[d]) {
                if (i.push(f.apply(e, h)), 1 === e.length) return !1;
            } else "object" != typeof d && d ? a.error("Method " + d + " does not exist in Fine Uploader's DnD module.") : b.apply(e, h);
        }), 1 === i.length ? i[0] : 1 < i.length ? i : this;
    };
}(jQuery), function(a) {
    ...
    var b = function(a, b, c) {
        ...
        b.imagesLoaded(function() {
            var b = this[0], e = b.naturalWidth, f = b.naturalHeight;
            c(), this.animate({
                opacity: 1
            }, 500), a.animate({
                height: d * f / e
    ...
    a(".gallery").each(function() {
        var c = a(this), d = 0, e = c.children(".photoset").children(), f = e.length, g = !0;
        b(c, e.eq(0), function() {
            g = !1;
    ...
    var b = /iPhone/i, c = /iPod/i, d = /iPad/i, e = /(?=.*\bAndroid\b)(?=.*\bMobile\b)/i, f = /Android/i, g = /IEMobile/i, h = /(?=.*\bWindows\b)(?=.*\bTouch\b)/i, i = /BlackBerry/i, j = /Opera Mini/i, k = /(?=.*\bFirefox\b)(?=.*\bMobile\b)/i, l = new RegExp("(?:Nexus 7|BNTV250|Kindle Fire|Silk|GT-P1000)", "i"), m = function(a, b) {
        return a.test(b);
    }, n = function(a) {
        ...
        }, this.seven_inch = m(l, n), this.any = this.apple.device || this.android.device || this.windows.device || this.other.device || this.seven_inch;
    }, o = a.isMobile = new n();
    o.Class = n;
}(window), $(function() {
    "use strict";
    $.fn.serializeObject = function() {
    ...
    }, window.up_button_animate_speed = 600, window.App = {
        initialize: function() {
            this.addScrollTop(), this.addMaskedInput(), this.addFileUploader(), this.addBriefHandler();
        },
        addBriefHandler: function() {
            var a = window.isMobile.any;
            a && $("a[href=#brief][data-toggle=modal]").on("click", function(a) {
                return a.preventDefault(), $("html, body").animate({
                    scrollTop: $("#contacts").offset().top
                }, self.up_button_animate_speed), !1;
            });
        },
        addFileUploader: function() {
            function a() {
                c.addClass("success").text("Спасибо за Ваш вопрос, скоро мы с вами свяжемся!"), 
                setTimeout(function() {
                    $("#brief").modal("hide"), $(".brief form").trigger("reset"), d.fineUploader("reset"), 
                    c.removeClass("success").text("Отправить");
                }, 500);
            }
            function b(a) {
                var b = JSON.parse(a.responseText), d = b.errors;
                c.addClass("error").text(d.join("; "));
            }
            var c, d = $("#dropbox").fineUploader({
                multiple: !1,
                autoUpload: !1,
                disableCancelForFormUploads: !0,
                validation: {
                    sizeLimit: 10485760
                },
                text: {
            ...
            d.on("error", function() {
                c.addClass("error").text("Ошибка :( пожалуйста позвоните нам");
            }).on("complete", a), $(".brief form").on("submit", function(e) {
                e.preventDefault();
                var f = $(this);
                if (c = $("[type=submit]", f), c.text("Загружаю...").removeClass("error"), d.fineUploader("getUploads").length > 0) d.fineUploader("setParams", f.serializeObject()), 
                d.fineUploader("setEndpoint", f.attr("action")), d.fineUploader("uploadStoredFiles"); else {
                    var g = $.post(f.attr("action"), f.serializeObject());
                    g.done(a), g.fail(b);
                }
                return !1;
            });
        ...
        addMaskedInput: function() {
            $("[name=phone]").mask("+9 (999) 999-99-99"), $("#callback").on("submit", this.requestCallback);
        },
        requestCallback: function(a) {
            a.preventDefault();
            var b = window.App, c = $(this), d = $("[type=submit]", c);
            if (!b.callbackWasSubmitted && !d.hasClass("disabled")) {
                var e = c.serializeArray(), f = e[0].value, g = e[1].value, h = [];
                f.length < 4 && h.push("Укажите Ваше имя и фамилию"), g.replace(/\D/g, "").length < 11 && h.push("Укажите ваш номер полностью");
                var i = $("ul.error");
                return 0 === h.length ? (i.addClass("hidden"), d.addClass("disabled"), $.post(c.attr("action"), $.param(e), function(a) {
                    a.success === !0 && (b.callbackWasSubmitted = !0, d.toggleClass("disabled success").text("Спасибо за Ваш вопрос, скоро мы с вами свяжемся!"), 
                    $("input, textarea", c).slideUp(200));
                }, "json")) : (i.empty().removeClass("hidden"), $.each(h, function() {
                    i.append("<li>" + this + "</li>");
                })), !1;
            }
        },
        addScrollTop: function() {
            var a = this;
            this.up = $("#up"), $(window).on("scroll", function() {
                var b;
                b = $(window).scrollTop(), a.is_animated || (b > 50 ? a.show_up_button() : a.hide_up_button());
            }), this.up.on("click", function() {
                $("html, body").animate({
                    scrollTop: 0
                }, a.up_button_animate_speed, function() {
                    a.hide_up_button();
                });
            });
        },
        show_up_button: function() {
            var a = this;
            this.up.data("is_visible") || (this.is_animated = !0, this.up.stop(!0, !0).transition({
                top: 0,
                opacity: 1
            }, a.up_button_animate_speed, function() {
                return a.is_animated = !1;
