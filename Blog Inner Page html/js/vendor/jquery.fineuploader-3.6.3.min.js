...
qq.Promise=function(){var a,b,c=[],d=[],e=[],f=0;return{then:function(e,k){0===f?(e&&c.push(e),k&&d.push(k)):-1===f&&k?k(b):e&&e(a);return this},done:function(a){0===f?e.push(a):a();return this},success:function(b){f=1;a=b;c.length&&qq.each(c,function(a,c){c(b)});e.length&&qq.each(e,function(a,b){b()});return this},failure:function(a){f=-1;b=a;d.length&&qq.each(d,function(b,c){c(a)});e.length&&qq.each(e,function(a,b){b()});return this}}};qq.isPromise=function(a){return a&&a.then&&a.done};
...
qq.UploadData=function(a){function b(a){if(qq.isArray(a)){var b=[];qq.each(a,function(a,c){b.push(e[f[c]])});return b}return e[f[a]]}function c(a){if(qq.isArray(a)){var b=[];qq.each(a,function(a,c){b.push(e[g[c]])});return b}return e[g[a]]}function d(a){var b=[];a=[].concat(a);qq.each(a,function(a,c){var d=k[c];void 0!==d&&qq.each(d,function(a,c){b.push(e[c])})});return b}var e=[],f={},g={},k={};return{added:function(b){var c=a.getUuid(b),d=a.getName(b),n=a.getSize(b),r=qq.status.SUBMITTING,d=e.push({id:b,
name:d,uuid:c,size:n,status:r})-1;f[b]=d;g[c]=d;void 0===k[r]&&(k[r]=[]);k[r].push(d);a.onStatusChange(b,void 0,r)},retrieve:function(a){if(qq.isObject(a)&&e.length){if(void 0!==a.id)return b(a.id);if(void 0!==a.uuid)return c(a.uuid);if(a.status)return d(a.status)}else return qq.extend([],e,!0)},reset:function(){e=[];f={};g={};k={}},setStatus:function(b,c){var d=f[b],n=e[d].status,r=qq.indexOf(k[n],d);k[n].splice(r,1);e[d].status=c;void 0===k[c]&&(k[c]=[]);k[c].push(d);a.onStatusChange(b,n,c)},uuidChanged:function(a,
...
qq.FineUploaderBasic=function(a){this._options={debug:!1,button:null,multiple:!0,maxConnections:3,disableCancelForFormUploads:!1,autoUpload:!0,request:{endpoint:"/server/upload",params:{},paramsInBody:!0,customHeaders:{},forceMultipart:!0,inputName:"qqfile",uuidName:"qquuid",totalFileSizeName:"qqtotalfilesize"},validation:{allowedExtensions:[],sizeLimit:0,minSizeLimit:0,itemLimit:0,stopOnFirstInvalidFile:!0,acceptFiles:null},callbacks:{onSubmit:function(a,c){},onSubmitted:function(a,c){},onComplete:function(a,
...
this,d),onSuccess:qq.bind(this._onValidateBatchCallbackSuccess,this,d,a,b,c),identifier:"batch validation"})},_upload:function(a,b,c){a=this._handler.add(a);var d=this._handler.getName(a);this._uploadData.added(a);b&&this.setParams(b,a);c&&this.setEndpoint(c,a);this._handleCheckedCallback({name:"onSubmit",callback:qq.bind(this._options.callbacks.onSubmit,this,a,d),onSuccess:qq.bind(this._onSubmitCallbackSuccess,this,a,d),onFailure:qq.bind(this._fileOrBlobRejected,this,a,d),identifier:a})},_onSubmitCallbackSuccess:function(a,
...
for(b in c)if(c[b]===a)return c.splice(b,1)},dispose:function(){l.dispose();g.dispose()}}};qq.DragAndDrop.callbacks=function(){return{processingDroppedFiles:function(){},processingDroppedFilesComplete:function(a){},dropError:function(a,b){qq.log("Drag \x26 drop error code '"+a+" with these specifics: '"+b+"'","error")},dropLog:function(a,b){qq.log(a,b)}}};
qq.UploadDropZone=function(a){function b(){return qq.safari()||qq.firefox()&&qq.windows()}function c(a){if(qq.ie()&&!qq.ie10())return!1;var b=a.dataTransfer,c=qq.safari();a=qq.ie10()?!0:"none"!==b.effectAllowed;return b&&a&&(b.files||!c&&b.types.contains&&b.types.contains("Files"))}function d(a){void 0!==a&&(g=a);return g}var e,f,g,k,l=new qq.DisposeSupport;e={element:null,onEnter:function(a){},onLeave:function(a){},onLeaveNotDescendants:function(a){},onDrop:function(a){}};qq.extend(e,a);f=e.element;
(function(a){k||(b?l.attach(document,"dragover",function(a){a.preventDefault()}):l.attach(document,"dragover",function(a){a.dataTransfer&&(a.dataTransfer.dropEffect="none",a.preventDefault())}),k=!0)})();(function(){l.attach(f,"dragover",function(a){if(c(a)){var b=qq.ie()?null:a.dataTransfer.effectAllowed;a.dataTransfer.dropEffect="move"===b||"linkMove"===b?"move":"copy";a.stopPropagation();a.preventDefault()}});l.attach(f,"dragenter",function(a){if(!d()&&c(a))e.onEnter(a)});l.attach(f,"dragleave",
...
0)};qq.extend(qq.FineUploader.prototype,qq.FineUploaderBasic.prototype);
...
b,c){this._totalFilesInBatch=a.length;this._filesInBatchAddedToUi=0;qq.FineUploaderBasic.prototype._prepareItemsForUpload.apply(this,arguments)}});
qq.AjaxRequestor=function(a){function b(a){var b=qq.indexOf(l,a),d=p.maxConnections;delete v[a];l.splice(b,1);l.length>=d&&b<d&&(a=l[d-1],c(a))}function c(a){var b=new XMLHttpRequest,c=f(),l={},x;p.onSend(a);p.paramsStore.getParams&&(l=p.paramsStore.getParams(a));x=l;var q=p.endpointStore.getEndpoint(a),z=v[a].addToPath;void 0!==z&&(q+="/"+z);x=k&&x?qq.obj2url(x,q):q;v[a].xhr=b;b.onreadystatechange=d(a);b.open(c,x,!0);p.cors.expected&&p.cors.sendCredentials&&(b.withCredentials=!0);e(a);g("Sending "+
c+" request for "+a);!k&&l?b.send(qq.obj2url(l,"")):b.send()}function d(a){var c=v[a].xhr;return function(){if(4===c.readyState){var d=v[a].xhr,e=f(),l=!1;b(a);0<=qq.indexOf(p.successfulResponseCodes,d.status)||(l=!0,g(e+" request for "+a+" has failed - response code "+d.status,"error"));p.onComplete(a,d,l)}}}function e(a){var b=v[a].xhr;a=p.customHeaders;b.setRequestHeader("X-Requested-With","XMLHttpRequest");b.setRequestHeader("Cache-Control","no-cache");qq.each(a,function(a,c){b.setRequestHeader(a,
c)})}function f(){return p.demoMode?"GET":p.method}var g,k,l=[],v=[],p={method:"POST",maxConnections:3,customHeaders:{},endpointStore:{},paramsStore:{},successfulResponseCodes:[200],demoMode:!1,cors:{expected:!1,sendCredentials:!1},log:function(a,b){},onSend:function(a){},onComplete:function(a,b,c){},onCancel:function(a){}};qq.extend(p,a);g=p.log;k="GET"===f()||"DELETE"===f();return{send:function(a,b){v[a]={addToPath:b};l.push(a)<=p.maxConnections&&c(a)},cancel:function(a){var c=v[a].xhr,d=f();c?
(c.onreadystatechange=null,c.abort(),b(a),g("Cancelled "+d+" for "+a),p.onCancel(a),a=!0):a=!1;return a}}};
...
qq.UploadHandler=function(a){function b(a){a=qq.indexOf(d,a);var b=e.maxConnections;0<=a&&(d.splice(a,1),d.length>=b&&a<b&&(a=d[b-1],g.upload(a)))}function c(a){f("Cancelling "+a);e.paramsStore.remove(a);b(a)}var d=[],e,f,g,k;e={debug:!1,forceMultipart:!0,paramsInBody:!1,paramsStore:{},endpointStore:{},cors:{expected:!1,sendCredentials:!1},maxConnections:3,uuidParamName:"qquuid",totalFileSizeParamName:"qqtotalfilesize",chunking:{enabled:!1,partSize:2E6,paramNames:{partIndex:"qqpartindex",partByteOffset:"qqpartbyteoffset",
chunkSize:"qqchunksize",totalParts:"qqtotalparts",filename:"qqfilename"}},resume:{enabled:!1,id:null,cookiesExpireIn:7,paramNames:{resuming:"qqresume"}},blobs:{paramNames:{name:"qqblobname"}},log:function(a,b){},onProgress:function(a,b,c,d){},onComplete:function(a,b,c,d){},onCancel:function(a,b){},onUpload:function(a,b){},onUploadChunk:function(a,b,c){},onAutoRetry:function(a,b,c,d){},onResume:function(a,b,c){},onUuidChanged:function(a,b){}};qq.extend(e,a);f=e.log;g=qq.supportedFeatures.ajaxUploading?
new qq.UploadHandlerXhr(e,b,e.onUuidChanged,f):new qq.UploadHandlerForm(e,b,e.onUuidChanged,f);return k={add:function(a){return g.add(a)},upload:function(a){return d.push(a)<=e.maxConnections?(g.upload(a),!0):!1},retry:function(a){return 0<=qq.indexOf(d,a)?g.upload(a,!0):this.upload(a)},cancel:function(a){var b=g.cancel(a);qq.isPromise(b)?b.then(function(){c(a)}):!1!==b&&c(a)},cancelAll:function(){var a=this,b=[];qq.extend(b,d);qq.each(b,function(b,c){a.cancel(c)});d=[]},getName:function(a){return g.getName(a)},
getSize:function(a){if(g.getSize)return g.getSize(a)},getFile:function(a){if(g.getFile)return g.getFile(a)},reset:function(){f("Resetting upload handler");k.cancelAll();d=[];g.reset()},expunge:function(a){return g.expunge(a)},getUuid:function(a){return g.getUuid(a)},isValid:function(a){return g.isValid(a)},getResumableFilesData:function(){return g.getResumableFilesData?g.getResumableFilesData():[]}}};
qq.UploadHandlerForm=function(a,b,c,d){function e(a){void 0!==y[a]&&(y[a](),delete y[a])}function f(a,b){var c=a.id,d=c.split("_")[0];B[s[d]]=b;y[d]=qq(a).attach("load",function(){r[d]&&(q("Received iframe load event for CORS upload request (iframe name "+c+")"),x[c]=setTimeout(function(){var a="No valid message received from loaded iframe for iframe name "+c;q(a,"error");b({error:a})},1E3))});z.receiveMessage(c,function(a){q("Received the following window message: '"+a+"'");var b=k(c.split("_")[0],
a),d=b.uuid;d&&B[d]?(q("Handling response for iframe name "+c),clearTimeout(x[c]),delete x[c],e(c),a=B[d],delete B[d],z.stopReceivingMessages(c),a(b)):d||q("'"+a+"' does not contain a UUID - ignoring.")})}function g(a,b){n.cors.expected?f(a,b):y[a.id]=qq(a).attach("load",function(){q("Received response for "+a.id);if(a.parentNode){try{if(a.contentDocument&&a.contentDocument.body&&"false"==a.contentDocument.body.innerHTML)return}catch(c){q("Error when attempting to access iframe during handling of upload response ("+
c+")","error")}b()}})}function k(a,b){var c;try{c=qq.parseJson(b),void 0!==c.newUuid&&(q("Server requested UUID change from '"+s[a]+"' to '"+c.newUuid+"'"),s[a]=c.newUuid,onUuidChanged(a,c.newUuid))}catch(d){q("Error when attempting to parse iframe upload response ("+d+")","error"),c={}}return c}function l(a){a=a+"_"+A;var b=qq.toElement('\x3ciframe src\x3d"javascript:false;" name\x3d"'+a+'" /\x3e');b.setAttribute("id",a);b.style.display="none";document.body.appendChild(b);return b}function v(a,b){var c=
n.paramsStore.getParams(a),d=qq.toElement('\x3cform method\x3d"'+(n.demoMode?"GET":"POST")+'" enctype\x3d"multipart/form-data"\x3e\x3c/form\x3e'),e=n.endpointStore.getEndpoint(a),f=e;c[n.uuidParamName]=s[a];n.paramsInBody?qq.obj2Inputs(c,d):f=qq.obj2url(c,e);d.setAttribute("action",f);d.setAttribute("target",b.name);d.style.display="none";document.body.appendChild(d);return d}function p(a){delete r[a];delete s[a];delete y[a];n.cors.expected&&(clearTimeout(x[a]),delete x[a],z.stopReceivingMessages(a));
if(a=document.getElementById(a+"_"+A))a.setAttribute("src","java"+String.fromCharCode(115)+"cript:false;"),qq(a).remove()}var n=a,r=[],s=[],y={},x={},q=d,z=new qq.WindowReceiveMessage({log:q}),B={},A=qq.getUniqueId(),C;return C={add:function(a){a.setAttribute("name",n.inputName);var b=r.push(a)-1;s[b]=qq.getUniqueId();a.parentNode&&qq(a).remove();return b},getName:function(a){if(C.isValid(a))return r[a].value.replace(/.*(\/|\\)/,"");q(a+" is not a valid item ID.","error")},isValid:function(a){return void 0!==
r[a]},reset:function(){r=[];s=[];y={};A=qq.getUniqueId()},expunge:function(a){return p(a)},getUuid:function(a){return s[a]},cancel:function(a){var b=n.onCancel(a,C.getName(a));return qq.isPromise(b)?b.then(function(){p(a)}):!1!==b?(p(a),!0):!1},upload:function(a){var c=r[a],d=C.getName(a),f=l(a),s;if(!c)throw Error("file with passed id was not added, or already uploaded or cancelled");n.onUpload(a,C.getName(a));s=v(a,f);s.appendChild(c);g(f,function(c){q("iframe loaded");if(!c){var h;try{var g=f.contentDocument||
f.contentWindow.document,l=g.body.innerHTML;q("converting iframe's innerHTML to JSON");q("innerHTML \x3d "+l);l&&l.match(/^<pre/i)&&(l=g.body.firstChild.firstChild.nodeValue);h=k(a,l)}catch(s){q("Error when attempting to parse form upload response ("+s+")","error"),h={success:!1}}c=h}e(a);n.cors.expected||qq(f).remove();if(c.success||!n.onAutoRetry(a,d,c))n.onComplete(a,d,c),b(a)});q("Sending upload request for "+a);s.submit();qq(s).remove()}}};
qq.UploadHandlerXhr=function(a,b,c,d){function e(a,b,c){var d=t.getSize(a);a=t.getName(a);b[m.chunking.paramNames.partIndex]=c.part;b[m.chunking.paramNames.partByteOffset]=c.start;b[m.chunking.paramNames.chunkSize]=c.size;b[m.chunking.paramNames.totalParts]=c.count;b[m.totalFileSizeParamName]=d;E&&(b[m.chunking.paramNames.filename]=a)}function f(a,b){var c=m.chunking.partSize,d=t.getSize(a),e=h[a].file||h[a].blobData.blob,f=c*b,c=f+c>=d?d:f+c,d=g(a);e=e.slice?e.slice(f,c):e.mozSlice?e.mozSlice(f,
c):e.webkitSlice?e.webkitSlice(f,c):void 0;return{part:b,start:f,end:c,count:d,blob:e,size:c-f}}function g(a){a=t.getSize(a);return Math.ceil(a/m.chunking.partSize)}function k(a){var b=new XMLHttpRequest;return h[a].xhr=b}function l(a,b,c,d){var e=new FormData,f=m.demoMode?"GET":"POST",l=m.endpointStore.getEndpoint(d),g=l,n=t.getName(d),k=t.getSize(d),s=h[d].blobData;a[m.uuidParamName]=h[d].uuid;E&&(a[m.totalFileSizeParamName]=k,s&&(a[m.blobs.paramNames.name]=s.name));m.paramsInBody||(E||(a[m.inputName]=
n),g=qq.obj2url(a,l));b.open(f,g,!0);m.cors.expected&&m.cors.sendCredentials&&(b.withCredentials=!0);return E?(m.paramsInBody&&qq.obj2FormData(a,e),e.append(m.inputName,c),e):c}function v(a,b){var c=m.customHeaders,d=h[a].file||h[a].blobData.blob;b.setRequestHeader("X-Requested-With","XMLHttpRequest");b.setRequestHeader("Cache-Control","no-cache");E||(b.setRequestHeader("Content-Type","application/octet-stream"),b.setRequestHeader("X-Mime-Type",d.type));qq.each(c,function(a,c){b.setRequestHeader(a,
c)})}function p(a,b,c){var d=t.getName(a),e=t.getSize(a);h[a].attemptingResume=!1;m.onProgress(a,d,e,e);m.onComplete(a,d,b,c);h[a]&&delete h[a].xhr;K(a)}function n(a){var b=h[a].remainingChunkIdxs[0],c=f(a,b),d=k(a),g=t.getSize(a),n=t.getName(a),r;void 0===h[a].loaded&&(h[a].loaded=0);D&&h[a].file&&x(a,c);d.onreadystatechange=y(a,d);d.upload.onprogress=function(c){if(c.lengthComputable){var d=c.loaded+h[a].loaded;c=c.total;var e=f(a,b);c-=e.size;var g=t.getSize(a),e=e.count,l=c-h[a].initialRequestOverhead;
h[a].lastRequestOverhead=c;0===b?(h[a].lastChunkIdxProgress=0,h[a].initialRequestOverhead=c,h[a].estTotalRequestsSize=g+e*c):h[a].lastChunkIdxProgress!==b&&(h[a].lastChunkIdxProgress=b,h[a].estTotalRequestsSize+=l);m.onProgress(a,n,d,h[a].estTotalRequestsSize)}};m.onUploadChunk(a,n,s(c));r=m.paramsStore.getParams(a);e(a,r,c);h[a].attemptingResume&&(r[m.resume.paramNames.resuming]=!0);r=l(r,d,c.blob,a);v(a,d);w("Sending chunked upload request for item "+a+": bytes "+(c.start+1)+"-"+c.end+" of "+g);
d.send(r)}function r(a){w("Server has ordered chunking effort to be restarted on next attempt for item ID "+a,"error");D&&(q(a),h[a].attemptingResume=!1);h[a].remainingChunkIdxs=[];delete h[a].loaded;delete h[a].estTotalRequestsSize;delete h[a].initialRequestOverhead}function s(a){return{partIndex:a.part,startByte:a.start+1,endByte:a.end,totalParts:a.count}}function y(a,b){return function(){if(4===b.readyState){var c;if(h[a]){w("xhr - server response received for "+a);w("responseText \x3d "+b.responseText);
try{c=qq.parseJson(b.responseText),void 0!==c.newUuid&&(w("Server requested UUID change from '"+h[a].uuid+"' to '"+c.newUuid+"'"),h[a].uuid=c.newUuid,onUuidChanged(a,c.newUuid))}catch(d){w("Error when attempting to parse xhr response text ("+d+")","error"),c={}}if(200!==b.status||!c.success||c.reset)if(c.reset&&r(a),h[a].attemptingResume&&c.reset)h[a].attemptingResume=!1,w("Server has declared that it cannot handle resume for item ID "+a+" - starting from the first chunk","error"),r(a),t.upload(a,
!0);else{var e=t.getName(a);m.onAutoRetry(a,e,c,b)||p(a,c,b)}else if(G){var e=h[a].remainingChunkIdxs.shift(),g=f(a,e);h[a].attemptingResume=!1;var e=h[a],l=e.loaded,g=g.size,k;k=E?h[a].lastRequestOverhead:0;e.loaded=l+(g+k);0<h[a].remainingChunkIdxs.length?n(a):(D&&q(a),p(a,c,b))}else p(a,c,b)}}}}function x(a,b){var c=t.getUuid(a),d=h[a].loaded,e=h[a].initialRequestOverhead,f=h[a].estTotalRequestsSize,g=B(a);qq.setCookie(g,c+u+b.part+u+d+u+e+u+f,m.resume.cookiesExpireIn)}function q(a){h[a].file&&
(a=B(a),qq.deleteCookie(a))}function z(a){var b=qq.getCookie(B(a));a=t.getName(a);var c,d,e;if(b){b=b.split(u);if(5===b.length)return a=b[0],c=parseInt(b[1],10),d=parseInt(b[2],10),e=parseInt(b[3],10),b=parseInt(b[4],10),{uuid:a,part:c,lastByteSent:d,initialRequestOverhead:e,estTotalRequestsSize:b};w("Ignoring previously stored resume/chunk cookie for "+a+" - old cookie format","warn")}}function B(a){var b=t.getName(a);a=t.getSize(a);var c=m.chunking.partSize,b="qqfilechunk"+u+encodeURIComponent(b)+
u+a+u+c;void 0!==F&&(b+=u+F);return b}function A(a,b){var c;for(c=g(a)-1;c>=b;c-=1)h[a].remainingChunkIdxs.unshift(c);n(a)}function C(a,b,c,d){c=d.part;h[a].loaded=d.lastByteSent;h[a].estTotalRequestsSize=d.estTotalRequestsSize;h[a].initialRequestOverhead=d.initialRequestOverhead;h[a].attemptingResume=!0;w("Resuming "+b+" at partition index "+c);A(a,c)}function I(a,b,c){var d=t.getName(a),e=f(a,b.part),e=m.onResume(a,d,s(e));qq.isPromise(e)?(w("Waiting for onResume promise to be fulfilled for "+a),
e.then(function(){C(a,d,c,b)},function(){w("onResume promise fulfilled - failure indicated.  Will not resume.");A(a,c)})):!1!==e?C(a,d,c,b):(w("onResume callback returned false.  Will not resume."),A(a,c))}function J(a){var b=h[a].file||h[a].blobData.blob,c=t.getName(a),d,e;h[a].loaded=0;d=k(a);d.upload.onprogress=function(b){b.lengthComputable&&(h[a].loaded=b.loaded,m.onProgress(a,c,b.loaded,b.total))};d.onreadystatechange=y(a,d);e=m.paramsStore.getParams(a);b=l(e,d,b,a);v(a,d);w("Sending upload request for "+
a);d.send(b)}function H(a){var b=h[a].xhr;b&&(b.onreadystatechange=null,b.abort());D&&q(a);delete h[a]}var m=a,K=b,w=d,h=[],u="|",G=m.chunking.enabled&&qq.supportedFeatures.chunking,D=m.resume.enabled&&G&&qq.supportedFeatures.resume,F;F=null!==m.resume.id&&void 0!==m.resume.id&&!qq.isFunction(m.resume.id)&&!qq.isObject(m.resume.id)?m.resume.id:void 0;var E=m.forceMultipart||m.paramsInBody,t;return t={add:function(a){var b,c=qq.getUniqueId();if(qq.isFile(a))a=h.push({file:a})-1;else if(qq.isBlob(a.blob))a=
h.push({blobData:a})-1;else throw Error("Passed obj in not a File or BlobData (in qq.UploadHandlerXhr)");if(D&&(b=z(a)))c=b.uuid;h[a].uuid=c;return a},getName:function(a){if(t.isValid(a)){var b=h[a].file;a=h[a].blobData;return b?null!==b.fileName&&void 0!==b.fileName?b.fileName:b.name:a.name}w(a+" is not a valid item ID.","error")},getSize:function(a){a=h[a].file||h[a].blobData.blob;return qq.isFileOrInput(a)?null!=a.fileSize?a.fileSize:a.size:a.size},getFile:function(a){if(h[a])return h[a].file||
h[a].blobData.blob},isValid:function(a){return void 0!==h[a]},reset:function(){h=[]},expunge:function(a){return H(a)},getUuid:function(a){return h[a].uuid},upload:function(a,b){var c=this.getName(a);this.isValid(a)&&(m.onUpload(a,c),G?!h[a].remainingChunkIdxs||0===h[a].remainingChunkIdxs.length?(h[a].remainingChunkIdxs=[],D&&!b&&h[a].file?(c=z(a))?I(a,c,0):A(a,0):A(a,0)):n(a):J(a))},cancel:function(a){var b=m.onCancel(a,this.getName(a));return qq.isPromise(b)?b.then(function(){H(a)}):!1!==b?(H(a),
!0):!1},getResumableFilesData:function(){var a=[],b=[];return G&&D?(a=void 0===F?qq.getCookieNames(RegExp("^qqfilechunk\\"+u+".+\\"+u+"\\d+\\"+u+m.chunking.partSize+"\x3d")):qq.getCookieNames(RegExp("^qqfilechunk\\"+u+".+\\"+u+"\\d+\\"+u+m.chunking.partSize+"\\"+u+F+"\x3d")),qq.each(a,function(a,c){var d=c.split(u),e=qq.getCookie(c).split(u);b.push({name:decodeURIComponent(d[1]),size:d[2],uuid:e[0],partIdx:e[1]})}),b):[]}}};
(function(a){var b,c,d,e,f,g,k,l,v,p;g=["uploaderType"];d=function(a){a&&(a=l(a),k(a),"basic"===f("uploaderType")?b(new qq.FineUploaderBasic(a)):b(new qq.FineUploader(a)));return c};e=function(a,b){var d=c.data("fineuploader");if(b)void 0===d&&(d={}),d[a]=b,c.data("fineuploader",d);else return void 0===d?null:d[a]};b=function(a){return e("uploader",a)};f=function(a,b){return e(a,b)};k=function(b){var d=b.callbacks={};b=new qq.FineUploaderBasic;a.each(b._options.callbacks,function(a,b){var e,f;e=/^on(\w+)/.exec(a)[1];
e=e.substring(0,1).toLowerCase()+e.substring(1);f=c;d[a]=function(){var a=Array.prototype.slice.call(arguments);return f.triggerHandler(e,a)}})};l=function(b,d){var e,k;e=void 0===d?"basic"!==b.uploaderType?{element:c[0]}:{}:d;a.each(b,function(b,c){0<=a.inArray(b,g)?f(b,c):c instanceof a?e[b]=c[0]:a.isPlainObject(c)?(e[b]={},l(c,e[b])):a.isArray(c)?(k=[],a.each(c,function(b,c){c instanceof a?a.merge(k,c):k.push(c)}),e[b]=k):e[b]=c});if(void 0===d)return e};v=function(c){return"string"===a.type(c)&&
!c.match(/^_/)&&void 0!==b()[c]};p=function(a){var c=[],d=Array.prototype.slice.call(arguments,1);l(d,c);return b()[a].apply(b(),c)};a.fn.fineUploader=function(e){var f=this,g=arguments,l=[];this.each(function(k,q){c=a(q);if(b()&&v(e)){if(l.push(p.apply(f,g)),1===f.length)return!1}else"object"===typeof e||!e?d.apply(f,g):a.error("Method "+e+" does not exist on jQuery.fineUploader")});return 1===l.length?l[0]:1<l.length?l:this}})(jQuery);
(function(a){function b(a){a||(a={});a.dropZoneElements=[k];a=e(a);d(a);c(new qq.DragAndDrop(a));return k}function c(a){var b=k.data(g);a?(void 0===b&&(b={}),b.dndInstance=a,k.data(g,b),a=void 0):a=void 0===b?null:b.dndInstance;return a}function d(b){var c=b.callbacks={};new qq.FineUploaderBasic;a.each(new qq.DragAndDrop.callbacks,function(a,b){var d;d=k;c[a]=function(){var b=Array.prototype.slice.call(arguments);return d.triggerHandler(a,b)}})}function e(b,c){var d,f;d=void 0===c?{}:c;a.each(b,function(b,
c){c instanceof a?d[b]=c[0]:a.isPlainObject(c)?(d[b]={},e(c,d[b])):a.isArray(c)?(f=[],a.each(c,function(b,c){c instanceof a?a.merge(f,c):f.push(c)}),d[b]=f):d[b]=c});if(void 0===c)return d}function f(a){var b=[],d=Array.prototype.slice.call(arguments,1);e(d,b);return c()[a].apply(c(),b)}var g="fineUploaderDnd",k;a.fn.fineUploaderDnd=function(d){var e=this,g=arguments,n=[];this.each(function(r,s){k=a(s);if(c()&&"string"===a.type(d)&&"dispose"===d&&void 0!==c()[d]){if(n.push(f.apply(e,g)),1===e.length)return!1}else"object"===
typeof d||!d?b.apply(e,g):a.error("Method "+d+" does not exist in Fine Uploader's DnD module.")});return 1===n.length?n[0]:1<n.length?n:this}})(jQuery);