...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    run: {
      ...
      'dist/built.js': 'font_src/*1.js',
      'dist/built1.js': ['font_src/*1.js', 'font_src/*2.js'],
      ...
      long1: {
        options: {a: 3, c: 33},
        files: {
          'dist/built-<%= build %>-a.js': ['font_src/*1.js'],
          'dist/built-<%= build %>-b.js': ['font_src/*1.js', 'font_src/*2.js'],
        }
      },
      long2: {
        options: {a: 4, c: 44},
        files: [
          {'dist/built-<%= build %>-a.js': ['font_src/*.whoops']},
          {'dist/built-<%= build %>-b.js': ['font_src/*1.js', 'font_src/*2.js']},
        ]
      },
      ...
      long3: {
        options: {a: 5, c: 55},
        files: [
          {dest: 'dist/built-<%= build %>-a.js', src: ['font_src/*2.js'], extra: 456},
          {dest: 'dist/built-<%= build %>-b.js', src: ['font_src/*1.js', 'font_src/*2.js'], extra: 789},
        ]
      },
