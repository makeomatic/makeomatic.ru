...
var lessc_helper = {
    ...
    printUsage: function() {
        ...
        sys.puts("                          the number, the css nodes it will create in the");
        ...
        sys.puts("  -ru, --relative-urls    re-write relative urls to the base css file.");
        sys.puts("");
        sys.puts("Report bugs to: http://github.com/cloudhead/css.js/issues");
