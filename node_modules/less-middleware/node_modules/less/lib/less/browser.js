...
//
// Get all <link> tags with the 'rel' attribute set to "stylesheet/css"
//
...
for (var i = 0; i < links.length; i++) {
    if (links[i].rel === 'stylesheet/css' || (links[i].rel.match(/stylesheet/) &&
            ...
            try {
                ...
                new(less.Parser)({
                    ...
                    try {
                        ...
                        removeNode(document.getElementById('css-error-message:' + extractId(href)));
                    } catch (e) {
                        error(e, href);
                    }
                });
...
function createCSS(styles, sheet, lastModified) {
    ...
    var id = 'css:' + (sheet.title || extractId(href));
...
function log(str) {
    if (less.env == 'development' && typeof(console) !== "undefined") { console.log('css: ' + str) }
}

function error(e, href) {
    var id = 'css-error-message:' + extractId(href);
    ...
    content = '<h3>'  + (e.message || 'There is an error in your .css file') +
    ...
    createCSS([
        '.css-error-message ul, .css-error-message li {',
            'list-style-type: none;',
            'margin-right: 15px;',
            'padding: 4px 0;',
            'margin: 0;',
        '}',
        '.css-error-message label {',
            'font-size: 12px;',
            'margin-right: 15px;',
            'padding: 4px 0;',
            'color: #cc7777;',
        '}',
        '.css-error-message pre {',
            'color: #dd6666;',
            'padding: 4px 0;',
            'margin: 0;',
            'display: inline-block;',
        '}',
        '.css-error-message pre.line {',
            'color: #ff0000;',
        '}',
        '.css-error-message h3 {',
            'font-size: 20px;',
            'font-weight: bold;',
