...
![схема БД и диспетчера данных](/blog/images/rational_database_3(1).png)
...
![схема с диспетчером кэша](/blog/images/rational_database_3(2).png)
...
![иллюстрация алгоритма LRU](/blog/images/rational_database_3(3).png)
...
![картинка доллара](/blog/images/rational_database_3(4).png)
...
![схема диспетчера блокировок](/blog/images/rrational_database_3(5).png)
...
![иллюстрация взаимоблокировки](/blog/images/rrational_database_3(6).png)
...
![иллюстрация конфликта блокировок без протокола двухфазной блокировки](/blog/images/rational_database_3(7).png)
...
![схема диспетчера логов](/blog/images/rational_database_3(8).png)
...
![иллюстрация примера лога запросов](/blog/images/rational_database_3(9).png)
...
![иллюстрация упрощённого процесса записи в лог](/blog/images/rational_database_3(10).png)
