...
Эта статья охватила множество техник, которые они использовали для оптимизации времени исполнения Javascript кода в их экземпляре AngularJS. Они уверены в том, что следует максимально увеличивать производительность и это только часть трюков, которые они использовали. В следующих статьях они опишут техники уменьшения запросов сети, задержки сети, и времени выполнения кода на сервере. Они так же предлагают обсудить опыт с AngularJS и подход, который они использовали для структурирования их кода приложения. Если вам стало интересно, напишите в комментариях.
